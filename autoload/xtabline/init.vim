...
com! -nargs=? -bang            XTabPaths               call xtabline#cmds#run("paths_style", <bang>0, <q-args>, 0)
com! -nargs=? -bang            XTabPathsAll            call xtabline#cmds#run("paths_style", <bang>0, <q-args>, 1)
