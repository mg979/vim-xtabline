...
com! -count                    XTabRelativePaths       call xtabline#cmds#run("relative_paths", <count>)
...
com! -count                    XTabMoveBufferTo        call xtabline#cmds#run('move_buffer_to', <count>)
